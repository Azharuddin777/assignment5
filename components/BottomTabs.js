    ...
    const tabs = [
        {
            ...
            selectedIcon:<FontAwesome name='home' size={30} color="orange"/>,  
        },
        {
            name:"stats",
            icon:<AntDesign name='piechart' size={25} color="#eee"/>,
            selectedIcon:<AntDesign name='piechart' size={25} color="orange"/>,
        },
        {
            name:"nav",
            icon:<Ionicons name="navigate" size={30} color="#eee"/>,
            selectedIcon:<Ionicons name="navigate" size={30} color="orange"/>,
        },
        {
            name:"alert",
            icon:<FontAwesome name='bell' size={25} color="#eee"/>,
            selectedIcon:<FontAwesome name='bell' size={25} color="orange"/>,
        }
    ]
